...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        var nameSortDescriptor = NSSortDescriptor(key: "name",
            ascending: true,
        ...
        var error: NSError?
        let fetchedResults = self.managedObjectContext!.executeFetchRequest(fetchRequest, error: &error) as? [BusStop]
    ...
    func importJSONSeedData() {
        ...
        for stop in stopArray {
            ...
            var busSet = NSMutableOrderedSet()
            for (index: String, subJson: JSON) in stop["buses"] {
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Bus@NUS.sqlite")
        var error: NSError? = nil
